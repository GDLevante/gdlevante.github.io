...
No existe modo de demostración: sin la URL y la clave pública de Supabase la aplicación muestra un aviso y no simula datos ni accesos. La puesta en producción se explica en `GUIA-DESPLIEGUE.md`.
